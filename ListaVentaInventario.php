...
<html lang="en" dir="ltr">
  ...
  <title>ABC Venta Inventario</title>
...
<?php
	...
	$vbd = "".$linea."";
	fCrearLogTNS($_SESSION["user"],'EL USUARIO '.$_SESSION["user"].' INGRESO EN LA OPCION (ABC VENTA INVENTARIO) DEL MENU EN LA PLATAFORMA WEB DE INVENTARIOS_AUTO',$vbd);
...
$("#btnExport").click(function(e){
			...
			window.open("ListaVentaInventario_excel.php","ventana1","width=1200,height=600,scrollbars=NO");
