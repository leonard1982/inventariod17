...
<?php
	...
	echo "<center>";
	echo "<br>";
	echo "<h2>ROTACIÓN INVENTARIO</h2>";
	echo "</center>";
...
?>		
		...
		<form action='' method='POST'>
			...
			<td><div style='text-align:left;'><label for="cant">Fecha Inicial:</label></div>
				<input class='form-control' id='cant' style='width: 200px;' type='date' value="<?php echo date('Y').'-01-01'; ?>" />
			</td>
			...
			<td>
				...
				<div class="input-group">
					<div style='margin-left:5px;'>
						<input type='button' id='actualizar' class='btn btn-success' style='float:right;' value='Generar'>
					</div>
