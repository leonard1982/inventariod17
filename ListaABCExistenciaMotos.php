...
<html lang="en" dir="ltr">
  ...
  <title>ABC Existencia Motos</title>
...
<?php
	...
	$vbd = "".$linea."";
	fCrearLogTNS($_SESSION["user"],'EL USUARIO '.$_SESSION["user"].' INGRESO EN LA OPCION (ABC EXISTENCIA MOTOS) DEL MENU EN LA PLATAFORMA WEB DE INVENTARIOS_AUTO',$vbd);
	if($cxf = new dbFirebird($vbd))
	{
		$vsql = "select m.descrip as descripcion,ms.existenc as existencia,ms.precio1 as precio,t.porciva as iva,coalesce(ms.precultprov,ms.costo) as costo,m.codigo as codigo from material as m inner join materialsuc as ms on(m.matid=ms.matid) inner join grupmat g on (m.grupmatid=g.grupmatid) inner join tipoiva as t on(m.tipoivaid=t.tipoivaid) where  m.codigo not like '%.'  and g.grupmatid  in(select gg.grupmatid from grupmat gg where gg.codigo BETWEEN '01.01.' AND '01.01.59') and ms.existenc>0 order by ms.existenc DESC";
					...
					<div class="input-group" style="justify-content: center;">
						...
						<div style="margin-left:10px;">
							<table class="table table-striped table-bordered">
								<thead>
									<th style="width:40px;"><center><a href='#marcaTOTAL'>TOTAL</a></center></th>
									<th style="width:40px;"><center><a href='#marca5'>5%</a></center></th>
									<th style="width:40px;"><center><a href='#marca15'>15%</a></center></th>
									<th style="width:40px;"><center><a href='#marca80'>80%</a></center></th>
								</thead>
...
$("#btnExportExistenciaInventario").click(function(e){
			...
			window.open("ListaABCExistenciaMotos_excel.php","ventana1","width=1200,height=600,scrollbars=NO");
