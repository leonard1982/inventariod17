...
if (empty($varchivopj) || empty($vbd_actual) || empty($vbd_anterior) || empty($vbd_inventarios)) {
...
if(isset($_POST['cant'])){
	...
	fCrearLogTNS($_SESSION["user"],'EL USUARIO '.$_SESSION["user"].' GENERO EL INFORME DE LA OPCION (COMPARATIVO) DEL MENU EN LA PLATAFORMA WEB DE INVENTARIOS_AUTO',$vbd_actual);
