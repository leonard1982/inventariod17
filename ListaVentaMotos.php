			...
			<div class="table-responsive">
				...
				<table class="table table-striped table-bordered " data-sortable style="align:center; width:90%;" id="tabledatos">
				  ...
				  <tr>
					...
					<th class="header" scope="col"><center>CODIGO</center></th>
					<th class="header" scope="col"><center>PRODUCTO</center></th>
					<th class="header" scope="col"><center>CANTIDAD</center></th>
					<th class="header" scope="col"><center>VENTA</center></th>
					<th class="header" scope="col"><center>UNIDAD</center></th>
					</tr>
				  </thead>
				  <tbody id="cuerpo">
...
$("#btnExport").click(function(e){
			...
			window.open("ListaVentaMotos_excel.php","ventana1","width=1200,height=600,scrollbars=NO");
